...
1. We recommend setting the name of the data product as the name of the function, the library will look for a manifest file with the same name. You can also set the name manually (see data product API definition)
...
1. **Deferred Execution:** This decorator ensures the function is registered but not executed during standard script imports or interactive kernel runs.
