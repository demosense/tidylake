...
The manifests files are the soul of your tidylake project. They serve a dual purpose: it is the documentation for your business assets and the technical data contract enforced in your [script file](scripts.md).
...
- **Testing:** Use the schema as the blueprint for [synthetic data generation in the compute engine plugin](plugins/compute-engine.md#synthetic-data).
- **Automation:** Feed product and column metadata directly into [catalog automations in the compute engine plugin](plugins/compute-engine.md#schema-automation) to keep your SQL metastore in sync with your code.
...
2. **Script:** The Python file containing the transformation logic.
