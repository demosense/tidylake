...
By design, tidylake only provides the core "orchestration of metadata" through [context](../context.md), [manifest](../manifests.md), and [script](../scripts.md) files. Our objective is to provide a methodology for managing complex data platforms without becoming a bottleneck for your technology choices.
...
### Compute Engine
The [compute engine plugin](./compute-engine.md) manages the end-to-end lifecycle of data serialization and storage. It handles:
...
To activate a plugin, reference it in your [context file](../context.md). Tidylake will dynamically load the module and inject it into your data product lifecycle.
